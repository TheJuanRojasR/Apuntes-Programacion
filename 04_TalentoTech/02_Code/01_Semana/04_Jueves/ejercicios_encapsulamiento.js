...
Descripción: Crea una clase Producto que encapsule la información sobre productos en un inventario. Cada producto debe tener propiedades privadas como nombre, precio, y cantidad. Implementa métodos para actualizar el precio y la cantidad, y otro método para mostrar la información completa del producto.
Requisitos:
    - Crear una clase Producto con las propiedades privadas nombre, precio, y cantidad.
    - Implementar métodos públicos actualizarPrecio(nuevoPrecio) y actualizarCantidad(nuevaCantidad) para modificar el precio y la cantidad.
